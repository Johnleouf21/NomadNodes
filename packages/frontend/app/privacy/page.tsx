    ...
    <div className="container max-w-4xl py-12">
      <Card>
        <CardContent className="prose dark:prose-invert max-w-none p-8">
          ...
          <p>
            La présente Politique de Confidentialité explique quelles données sont collectées sur le
            Site Nomad Nodes et comment elles sont traitées. Nomad Nodes respecte pleinement le{" "}
            <strong>RGPD</strong>.
          </p>
          ...
          <p>
            Nomad Nodes collecte uniquement les données strictement nécessaires au fonctionnement de
            la réservation :
          </p>
          <ul>
            <li>Nom</li>
          ...
          <ul>
            <li>
              transmettre à l&apos;hôte les informations nécessaires à l&apos;accueil du voyageur,
            </li>
          ...
          <p>
            Les informations sont <strong>directement transmises par email</strong> à l&apos;hôte au
            moment de la réservation. Aucune base de données n&apos;en conserve une copie.
          </p>
          ...
          <p>
            Cette Politique peut être mise à jour à tout moment. La date de mise à jour ci-dessus
            fait foi.
          </p>
        </CardContent>
      </Card>
