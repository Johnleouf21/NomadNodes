          ...
          <Card>
            <CardContent className="prose dark:prose-invert max-w-none p-8">
              ...
              <p>
                ...
                »), une plateforme permettant la mise en relation entre hôtes et voyageurs, ainsi
                que la certification d&apos;avis via un mécanisme Web3 (Proof-of-Stay / SBT).
              </p>
              ...
              <p>
                Nomad Nodes est une <strong>plateforme de mise en relation</strong> entre voyageurs
                et hôtes. Le Site permet notamment :
              </p>
              <ul>
              ...
              <p>
                Nomad Nodes <strong>n&apos;est pas une agence de voyage</strong>. Le contrat de
                séjour est conclu <strong>directement</strong> entre l&apos;hôte et le voyageur.
              </p>

              <hr className="my-8" />

              <h2 className="text-xl font-semibold">
                2. Absence de services sur actifs numériques
              </h2>
              <p>
                Les tokens utilisés sur Nomad Nodes (SBT, jetons utilitaires non transférables) :
              </p>
              <ul>
              ...
              <p>
                Ils servent uniquement à certifier une expérience (preuve de séjour, réputation).
              </p>
              <p>
                Nomad Nodes ne propose <strong>aucun service sur actifs numériques</strong> et ne
                relève pas du règlement MiCA ou du régime PSAN.
              </p>
              ...
              <p>
                Ces données sont utilisées <strong>uniquement</strong> pour transmettre les
                informations nécessaires à l&apos;hôte.
              </p>
              <p>
                <strong>Aucune base de données ne stocke ces informations.</strong> Elles sont
                envoyées directement par email à l&apos;hôte concerné. Le Site ne conserve aucune
                copie.
              </p>
              ...
              <p>
                Tous les éléments du Site (textes, logos, design, images) sont la propriété
                exclusive de Nomad Nodes.
              </p>
